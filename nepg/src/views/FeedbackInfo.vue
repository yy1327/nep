        ...
        <form @submit.prevent="submitData">
          <div class="form-row">
            <div class="form-group">
              ...
              <input type="number" step="0.01" v-model="form.pm25Value" required>
            </div>
            <div class="form-group">
              <label>PM10 (μg/m³)</label>
              <input type="number" step="0.01" v-model="form.pm10Value" required>
            </div>
          </div>
          <div class="form-row">
            <div class="form-group">
              <label>SO2 (μg/m³)</label>
              <input type="number" step="0.01" v-model="form.so2Value" required>
            </div>
            <div class="form-group">
              <label>NO2 (μg/m³)</label>
              <input type="number" step="0.01" v-model="form.no2Value" required>
            </div>
          </div>
          <div class="form-row">
            <div class="form-group">
              <label>CO (mg/m³)</label>
              <input type="number" step="0.01" v-model="form.coValue" required>
            </div>
            <div class="form-group">
              <label>O3 (μg/m³)</label>
              <input type="number" step="0.01" v-model="form.o3Value" required>
            </div>
          </div>
          <div class="form-group">
            <label>确认备注</label>
            <textarea v-model="form.desc" placeholder="请输入确认备注"></textarea>
          </div>
