  ...
  <div class="feedback-list">
    <el-card>
      <div class="search-bar">
        <el-input v-model="searchForm.afCode" placeholder="反馈编号" clearable style="width: 150px"></el-input>
        <el-select v-model="searchForm.afState" placeholder="状态" clearable style="width: 120px">
      ...
      <el-table :data="tableData" border stripe>
        <el-table-column prop="af_code" label="反馈编号" width="150"></el-table-column>
        <el-table-column prop="supervisor_name" label="监督员"></el-table-column>
        ...
        <el-table-column prop="af_state" label="状态">
          <template slot-scope="scope">
            <el-tag :type="getStatusType(scope.row.af_state)">{{ getStatusText(scope.row.af_state) }}</el-tag>
          </template>
        </el-table-column>
        <el-table-column prop="create_time" label="创建时间" width="180"></el-table-column>
        <el-table-column label="操作" width="200">
          <template slot-scope="scope">
            <el-button size="mini" @click="viewInfo(scope.row.af_id)">详情</el-button>
