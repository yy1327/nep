  ...
  <div class="statis-page">
    ...
    <div class="gauge-row">
      <el-card class="gauge-card">
        <div slot="header"><span>🎯 优良率仪表盘</span></div>
        <div id="gaugeGoodRate" class="gauge-box"></div>
      </el-card>
      <el-card class="gauge-card">
        <div slot="header"><span>📊 省份覆盖率</span></div>
